...
- **Physical perception:** PPM is a dedicated physical-perception tool that provides object-centric evidence about properties, interactions, material responses, and state transitions.
...
PPM is the physical-perception observer used by OmniFysics-Agent. It analyzes representative images for object properties, material, contact, support, deformation, motion, interaction relations, and likely state changes or outcomes.
